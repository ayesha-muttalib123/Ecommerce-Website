...
import LatestProducts from "./Leatest";
import ProductGrid from "./Products";
import Footer from "../components/Footer/Footer";
import RemainSection from "./RemainSection";
...
<section className="relative bg-gray-100 py-10 md:py-20 px-5 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
  ...
  className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-white border border-gray-300 rounded-full p-2 hover:bg-gray-100 md:left-5 ] "
>
  ❮
</button>
<button
  onClick={handleNextSlide}
  className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-white border border-gray-300 rounded-full p-2 hover:bg-gray-100 md:right-5"
>
  ❯
</button>
