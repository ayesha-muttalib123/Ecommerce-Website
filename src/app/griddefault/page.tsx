  ...
  return (
    <>
      <div className="bg-gray-50 py-12">
        {/* Full-Width Section */}
        <div className="w-full bg-[#F6F5FF] py-10">
          <div className="text-center p-5 mx-auto max-w-7xl rounded-md">
            <h1 className="text-4xl font-bold text-gray-900">Shop Grid Default</h1>
